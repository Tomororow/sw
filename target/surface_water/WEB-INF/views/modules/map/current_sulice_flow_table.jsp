...
<html>
  <head>
    ...
    <title>My JSP 'current_sulice_flow_table.jsp' starting page</title>
...
//			var twoSecond = 2 * 1000;
			...
			option = {
				tooltip: {//这部分与提示框有关，与Y坐标自适应无关
					...
					formatter: function (params){//需要接收一个参数数组(格式化以坐标显示的内容)
						...
						return date.getHours()-1 + '时'+date.getMinutes()+ '分'+  date.getSeconds()+'秒      流量:' + params.value[1]+'立方米';
					},
					axisPointer: {//坐标轴指示器
			...
			function getCycleDate(){
				...
				$.ajax({
					...
					data: {canCode:devicewaterCode,type:2}, 	
					type: "post",
					async: false,//非异步
