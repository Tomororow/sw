				...
				<div class="center-back right-back">
					<div class="container-fluid">
						<div class="info-center">
								...
								<div class="col-md-12">
									<div class="btn-group pull-left" role="group" aria-label="...">
										<div class="form-group">
											<span class="pull-left form-span" style="font-size: 16px;">&nbsp;请选择雨量站:</span>
											<!-- 动态加载站点下拉框 -->
											<div id="getStationById" style="display: inline-block;"></div>
										</div>
									</div>
								</div>
							</div>
							...
							<!-- 实时雨情折线图 -->
							<div id="rainChart" style="width:1000px; height:380px; margin: 0 auto;"></div>
							<!-- 实时雨情表格形式展现 -->
								...
								<table class="table table-bordered table-header">
									<thead>
										<tr>
											...
											<td class="w10">5分钟降雨(mm)</td>
											<td class="w10">10分钟降雨(mm)</td>
											<td class="w10">30分钟降雨(mm)</td>
											<td class="w10">1小时降雨(mm)</td>
											<td class="w10">3小时降雨(mm)</td>
											<td class="w10">6小时降雨(mm)</td>
											<td class="w10">12小时降雨(mm)</td>
											<td class="w10">24小时降雨(mm)</td>
										</tr>
									</thead>
									
									<tbody id="dynamicRainList">
	...
	<script type="text/javascript">
		...
		function showNodes(){
			...
			<c:forEach items="${sysAreaTreeList}" var="areaInfos">
				...
				if(level==0){
					zNode={id:id, pId:pId, name:name, click:"getRainSiteByArea('${areaInfos.id}');", open:true};
				}else{
					zNode={id:id, pId:pId, name:name, click:"getRainSiteByArea('${areaInfos.id}');", open:false};
				}
				zNodes.push(zNode);
			</c:forEach>;
		}
