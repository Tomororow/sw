...
<body >
			...
			<div ui-layout class="layout-mock">
				...
				<sidebar class="east-back left-back" >
					 <ul id="tree" class="nav nav-pills nav-stacked">
						<li><h4 style="margin-left:20px;margin-top:20px">水厂区</h2>
						</li>
								...
								<table class="table table-bordered table-header">
									<thead>
										<tr>
											...
											<td class="w10">设备名称</td>
											<td class="w10">厂商</td>
											<td class="w10">厂商电话</td>
											<td class="w10">设备照片</td>
											<td class="w10">购买时间</td>
											<td class="w10">备注</td>
											<td class="w10">操作</td>
										</tr>
									</thead>
	...
	<script type="text/javascript" src="${ctxstc}/js/custom/watersupply/equipment/equipment.js"></script>
	<script>
