			                ...
			                <div class="main-left width-100" style="margin-top:0px">
			                    ...
			                    <div id="TAB-1" class="width left min-tab" style="width: ">
			                    	<div class="search-box row" style="width: 100%;">
										...
										<div class="clearfix"></div>
										<div class="table-margin">
											<table class="table table-bordered table-header" style="width: 30%">
												<thead>
													<tr>
											...
											<table  class="table table-bordered table-header" style="position:absolute;top:161px;left:31%;width: 30%">
												<thead>
													<tr>
														<td class="w5" rowspan="3">序号</td>
														<td class="w5" rowspan="3">年份</td>
											...
											<table class="table table-bordered table-header" style="position:absolute;top:161px;left:61.3%;width: 30%">
												<thead>
													<tr>
														<td class="w5" rowspan="3">序号</td>
														<td class="w5" rowspan="3">年份</td>
