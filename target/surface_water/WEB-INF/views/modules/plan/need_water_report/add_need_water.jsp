		...
		<div style="padding: 30px; line-height: 22px; background-color: #393D49; color: #fff; font-weight: 300;">
    				...
    				<table class="border="0" style="border-collapse:separate; border-spacing:20px 18px;">
						...
						<tr>
							...
							<td class="w18">
								<select  name="soilType" class="form-control" style="color:black;width:180px;height:35px;" onchange="waterAreaChange(this[selectedIndex].value);" >
									<option>请选择</option>
							...
							<td class="w18">
								<select  name="cropsType" class="form-control" style="color:black;width:180px;height:35px;" onchange="waterAreaChange(this[selectedIndex].value);">
									<option>请选择</option>
						...
						<tr>	
							<td align="right"><span style="color: red">*</span>面积</td><td class="w18"><input class="form-control" type="text" name="area" value="" style="color:black;width:180px;"/></td>
						...
						<tr>	
							<td align="right">提报人</td><td class="w18"><input class="form-control" type="text" name="reportPeopleName" value="" style="color:black;width:180px;"/></td>
							<td align="right">电话</td><td class="w18"><input class="form-control" type="text"  name="phoneNumber" value="" style="color:black;width:180px;"/></td>
						</tr>
    				...
    				<!-- <input  type="text"  hidden="hidden" id="year" name="year"  style="color:black;width:180px;"/> -->
	        		</form>
       		 </div>
