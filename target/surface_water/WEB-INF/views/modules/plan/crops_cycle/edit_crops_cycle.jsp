...
<body>
	<div align="center" style="background-color: #393D49; color: #fff; padding-top: 25px; padding-bottom: 25px;">
		<form id="cropsCycleEditForm" action="${ctx}/cropsCycle/editSaveCropsCycleInfo" method="post">
			<input type="hidden" id="id" name="id" value="${cropsGrowthCycle.id}">
			<table border="0" cellspacing="15" style="line-height: 25px; border-collapse:separate; border-spacing:0px 10px;">
				<tr>
					<td align="right"><span style="color: red">*</span>生长周期名称：</td>
					<td><input type="text" id="cycleName" name="cycleName" value="${cropsGrowthCycle.cycleName}" style="color:black; width:233px;"/></td>
				</tr>
				
				<tr>
					<td align="right">生长周期描述：</td>
					<td><textarea id="description" name="description" rows="2" cols="35" maxlength="256" style="color:black; resize:none;">${cropsGrowthCycle.description}</textarea></td>
				</tr>
				
				<tr>
					<td align="right">备注信息：</td>
					<td><textarea id="cgcRemark" name="cgcRemark" rows="2" cols="35" maxlength="256" style="color:black; resize:none;">${cropsGrowthCycle.cgcRemark}</textarea></td>
				</tr>
			</table>
		</form>
	</div>
