...
<body >
		<div style="padding: 30px; line-height: 22px; background-color: #393D49; color: #fff; font-weight: 300;">
    				...
    				<table class="border="0" style="border-collapse:separate; border-spacing:20px 18px;">
						...
						<tr>	
							<td align="right"><span style="color: red">*</span>所属用户：</td><td class="w18"><select class="form-control" id="consumerId" name="consumerId" value="" style="color:black;width:180px;"></select></td>
							<td align="right"><span style="color: red">*</span>土地名称：</td><td class="w18"><input type="text" class="form-control" id="soilName" name="soilName" value="${soilName}" style="color:black;width:180px;"/></td>
						</tr>
						
						<tr>
							<td align="right"><span style="color: red">*</span>所属渠道：</td><td class="w18"><input type="text" class="form-control" readonly="readonly"  name="canalName" value="${canalName}" style="color:black;width:180px;"/></td>
							<td align="right"><span style="color: red">*</span>土质：</td>
							<td class="w18">
								<select  name="soilTypeCode" id="soilTypeCode" style="color:black;width:180px;height:35px;" class="form-control" onchange="waterAreaChange(this[selectedIndex].value);">
						...
						<tr>	
							<td align="right"><span style="color: red">*</span>经度：</td><td class="w18"><input type="text" class="form-control"class="form-control" id="x" name="x" value="${x}" style="color:black;width:180px;"/></td>
							<td align="right"><span style="color: red">*</span>纬度：</td><td class="w18"><input type="text" class="form-control" id="y"  name="y" value="${y}" style="color:black;width:180px;"/></td>
						</tr>
						
						<tr>	
							<td align="right"><span style="color: red">*</span>海拔：</td><td class="w18"><input type="text"class="form-control" id="z" name="z" value="${z}" style="color:black;width:180px;"/></td>
							<td align="right"><span style="color: red">*</span>面积：</td><td class="w18"><input type="text" class="form-control" id="soilArea" name="soilArea" value="${soilArea}" style="color:black;width:180px;"/></td>
						</tr>
						
						<tr>
							<td align="right">承包开始时间：</td><td class="w18"><input type="text" class="form-control"  name="contractStartYear" value="<fmt:formatDate value='${contractStartYear}' type='date' pattern='yyyy-MM-dd'/>"    style="color:black;width:180px;" onfocus="WdatePicker({'skin':'whyGreen','dateFmt':'yyyy-MM-dd'});" /></td>
							<td align="right">承包结束时间：</td><td class="w18"><input type="text" class="form-control"  name="contractEndYear"   value="<fmt:formatDate value='${contractEndYear}' type='date' pattern='yyyy-MM-dd'/>" style="color:black;width:180px;"  onfocus="WdatePicker({'skin':'whyGreen','dateFmt':'yyyy-MM-dd'});" /></td>
						</tr>
						
						<tr>
							<td align="right">地址：</td>
							<td class="w18"  colspan="3">
								<textarea  name="address" cols="60" rows="1" class="form-control" style="color:black;">${address}</textarea> 
							</td>
						</tr>
						...
						<tr>
							...
							<td class="w18"  colspan="3">
								<textarea  name="remake" cols="60" rows="1" class="form-control" style="color:black;">${remake}</textarea> 
							</td>
						</tr>
