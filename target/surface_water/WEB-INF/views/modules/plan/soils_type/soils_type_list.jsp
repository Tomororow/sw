...
<form  action="" method="post">
								...
								<table class="table table-bordered table-header">
									<thead>
										<tr>
											...
											<td class="w8">土地类型编码</td>
											<td class="w10">所属行政区域</td>
											<td class="w10">土地类型名称</td>
											<td class="w10">土质系数</td>
											<td class="w10">土地类型描述</td>
	...
	<script type="text/javascript" src="${ctxstc}/js/custom/plan/soils_type/soils_type_list.js"></script>
			...
			if(areaId==null||areaId==""){
				...
				//alert("111");
				 layer.open({
				        ...
				        ,shade: 0.8
				        ,maxmin: true
				        ,content: '${ctx}/soils/addPage?areaId='+areaId
				        ,btn: ['确定', '关闭'] //只是为了演示
				        ,yes: function(){
				        	//子页面提交
				        	insertSubmit();
				        	layer.confirm('你的预测添加成功', {
			        			...
			        			document.forms[0].action="${ctx}/soils/list?state=35";
