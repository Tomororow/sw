...
<body >
    	...
    	<form  id="form" action="${ctx}/site_water_manage/add" method="post" enctype="multipart/form-data">
    		...
    		<div style="border:1px solid white;width:100%;border-radius:10px">
    			<table border="0" cellspacing="50px" style="line-height: 35px; border-collapse:separate; border-spacing:0px 10px;">
					<tr>	
						<td class="w7"><span style="color: red">&nbsp;&nbsp;*&nbsp;</span>站点编码:</td><td class="w18"><input type="text" class="form-control" id="deviceWaterCode" name="deviceWaterCode" value="" style="color:black;width:180px;height:30px"/></td>
						<td class="w7"><span style="color: red">&nbsp;&nbsp;*&nbsp;</span>站点名称:</td><td class="w18"><input type="text" class="form-control" id="deviceWaterName" name="deviceWaterName" value="" style="color:black;width:180px;height:30px"/></td>
					</tr>
					<tr>	
					...
					<tr>	
						<td class="w7"><span style="color: red">&nbsp;&nbsp;*&nbsp;</span>建设时间:</td><td class="w18"><input type="text" class="form-control" id="swiBuildTime" name="swiBuildTime" value="${siteWaterInfo.swiBuildTime}" style="color:black;width:180px;height:30px" onfocus="WdatePicker({'skin':'whyGreen','dateFmt':'yyyy-MM-dd'});" /></td>
					...
					<tr>	
						<td class="w7"><span style="color: red">&nbsp;&nbsp;*&nbsp;</span>站点空高:</td><td class="w18"><input type="text" class="form-control" id="siteDepth" name="siteDepth" value="${siteWaterInfo.swiLongitude}" style="color:black;width:180px;height:30px"/></td>
						<td class="w7"><span style="color: red">&nbsp;&nbsp;*&nbsp;</span>渠底高程:</td><td class="w18"><input type="text" class="form-control" id="siteCanalBottomHeight" name="siteCanalBottomHeight" value="${siteWaterInfo.swiLatitude}" style="color:black;width:180px;height:30px" /></td>
					</tr>
					 <tr>	
						<td class="w7"><span style="color: red">&nbsp;&nbsp;*&nbsp;</span>站点海拔:</td><td class="w18"><input type="text" class="form-control" id="swiHight" name="swiHight" value="${siteWaterInfo.swiLongitude}" style="color:black;width:180px;height:30px"/></td>
						<td class="w7"><span style="color: red">&nbsp;&nbsp;*&nbsp;</span>设备类型:</td>
						<td class="w18">
							<select id="swiDevicemodelCode" class="form-control" onchange="handleDeviceType(this)" name="swiDevicemodelCode" style="color:black;width:180px;height:30px;padding-bottom:2px;">
									<option>请选择</option>
					...
					<tr id="tierNum" style="display: none;">
					 	<td class="w7"><span style="color: red">&nbsp;&nbsp;*&nbsp;</span>换能器层级:</td><td class="w18"><input type="number" onkeyup="if(value > 7 || value < 1 ){alert('非法输入,必须输入数字且最多可输入1~7层');value = ''}" class="form-control" id="siteDepth" name="siteDepth" value="${siteWaterInfo.tierNum}" style="color:black;width:180px;height:30px"/></td>
					</tr>
					<tr>	
						<td class="w7">&nbsp;&nbsp;站点地址:</td>
						<td class="w18"  colspan="3">
							<textarea  name="swiAddr" class="form-control" cols="50" rows="1" style="color:black;"></textarea> 
						</td>
					</tr>
					<tr>
						<td class="w7">&nbsp;&nbsp;站点备注:</td>
						<td class="w18"  colspan="3">
							<textarea  name="swiRemark" class="form-control" cols="50" rows="1" style="color:black;"></textarea> 
						</td>
					</tr> 
				</table>
    		</div><br/>
	...
	function handleDeviceType(e){
		debugger
		var der = $('#swiDevicemodelCode option:selected').text();
		if(der=='雷达式水位计'){
			$("#tierNum").css("display","");
		}else{
			$("#tierNum").css("display","none");
		}
	}
	//给父页面传值所用信息
