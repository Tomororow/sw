...
<body >
		<div style="padding: 30px; line-height: 22px; background-color: #393D49; color: #fff; font-weight: 300;">
    				...
    				<form  id="form" action="${ctx}/site_speed_manage/add" method="post" enctype="multipart/form-data">
    				...
    				<table class="table table-bordered table-header">
						...
						<tr>	
							<td class="w7">站点建设时间</td><td class="w18"><input type="text" name="ssiBuildTime" value="${siteSpeedInfo.ssiBuildTime}" style="color:black;width:180px;" onfocus="WdatePicker({'skin':'whyGreen','dateFmt':'yyyy-MM-dd'});" /></td>
						...
						<tr>
							...
							<td class="w18">
								<select id="ssiDevicemodelCodeSelect" name="ssiDeviceCode" style="color:black;width:180px;height:30px;">
										<option>请选择</option>
