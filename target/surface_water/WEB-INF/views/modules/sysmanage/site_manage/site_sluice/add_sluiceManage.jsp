...
<body >
		<div style="padding: 30px; line-height: 22px; background-color: #393D49; color: #fff; font-weight: 300;">
    				...
    				<table border="0" style="border-collapse:separate; border-spacing:20px 18px;">
						...
						<tr>	
							<td align="right"><span style="color: red">*</span>关联视频站:</td><td class="w18"><input class="form-control" type="text" id="sluiceMovieSiteId" name="sluiceMovieSiteId"  style="color:black;width:180px;"/></td>
						</tr>
