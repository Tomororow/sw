							...
							<div class="search-box row">
								<div class="col-md-12">
									<div class="btn-group pull-left" role="group" aria-label="...">
										<button id="add_area" style="display: none" type="button" class="btn btn-default" onclick="addArea()">
											<span class="glyphicon glyphicon-plus"></span>新增
										</button>
									
										<button id="delete_area" style="display: none" type="button" class="btn btn-default" onclick="doDelete()">
	...
	<script type="text/javascript">
		...
		function showNodes(threeLevelPermission){
			...
			<c:forEach items="${sysAreaList}" var="areaInfos">
				...
				//if(level==0){
					zNode={id:id, pId:pId, name:name, click:"loadAreasInfo('${areaInfos.id}',1,'"+threeLevelPermission+"');", open:true};
				//}else{
		...
		$(function (){
			...
			// 树菜单节点点击
			loadAreasInfo(maxPid,1,threeLevelPermission);
		});
