...
//菜单切换管理
function addCanal(){
	$('#righteject_canal strong').addClass("rightejectthis_canal").next("div").animate({height: '+400px'}, "slow");
}
function removeCanal(){
	$('#righteject_canal strong').removeClass("rightejectthis_canal").next("div").animate({height: '-400px'}, "slow");
}

function addReservoir(){
	$('#righteject_reservoir strong').addClass("rightejectthis_reservoir").next("div").animate({height: '+400px'}, "slow");
}
function removeReservoir(){
	$('#righteject_reservoir strong').removeClass("rightejectthis_reservoir").next("div").animate({height: '-400px'}, "slow");
}

function addRain(){
	$('#righteject_rain strong').addClass("rightejectthis_rain").next("div").animate({height: '+400px'}, "slow");
}
function removeRain(){
	$('#righteject_rain strong').removeClass("rightejectthis_rain").next("div").animate({height: '-400px'}, "slow");
}

function addSluice(){
	$('#righteject_sluice strong').addClass("rightejectthis_sluice").next("div").animate({height: '+400px'}, "slow");
}
function removeSluice(){
	$('#righteject_sluice strong').removeClass("rightejectthis_sluice").next("div").animate({height: '-400px'}, "slow");
}
function addWater(){
	$('#righteject_water strong').addClass("rightejectthis_water").next("div").animate({height: '+400px'}, "slow");
}
function removeWater(){
	$('#righteject_water strong').removeClass("rightejectthis_water").next("div").animate({height: '-400px'}, "slow");
}
function addVideo(){
	$('#right_video strong').addClass("rightthis_video").next("div").animate({height: '+400px'}, "slow");
}
function removeVideo(){
	$('#right_video strong').removeClass("rightthis_video").next("div").animate({height: '-400px'}, "slow");
}
