...
function popup(type, model, text, title){
	switch(type){
		...
		case 4: //AJAX 开始
			...
			setTimeout(function() {
				switch(model){
					case 1: var Num = 'public/img/1.gif';break; //
					case 2: var Num = 'public/img/2.gif';break; //
					case 3: var Num = 'public/img/3.gif';break; //
					case 4: var Num = 'public/img/4.gif';break; //
					case 5: var Num = 'public/img/5.gif';break; //
					case 6: var Num = 'public/img/6.gif';break; //
					case 7: var Num = 'public/img/7.gif';break; //
				}
