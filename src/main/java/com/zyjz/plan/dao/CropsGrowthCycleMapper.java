...
/**
 * @ClassName: CropsGrowthCycleMapper
 * @Description: 农作物生长周期dao接口
 * @Author: zhaojx
 * @Date: 2018年2月28日 下午5:33:14
 */
public interface CropsGrowthCycleMapper {
    ...
    CropsGrowthCycle getCycleNameList(String cycleCode);
     ...
     * @throws
     */
	List<CropsGrowthCycle> findGrowthCycleBy_soilType_cropsType(@Param("comm2") String comm2, @Param("comm3") String comm3);
}