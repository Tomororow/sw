...
public class DrivenSurveySite implements Serializable {
    ...
    private String drivenAddress;

    private String drivenImage;
    ...
    public String getDrivenName() {
        return drivenName;
    }

    public void setDrivenName(String drivenName) {
        this.drivenName = drivenName == null ? null : drivenName.trim();
    }
    ...
    public String getDrivenAddress() {
        return drivenAddress;
    }

    public void setDrivenAddress(String drivenAddress) {
        this.drivenAddress = drivenAddress == null ? null : drivenAddress.trim();
    }

    public String getDrivenImage() {
        return drivenImage;
    }

    public void setDrivenImage(String drivenImage) {
        this.drivenImage = drivenImage == null ? null : drivenImage.trim();
    }
