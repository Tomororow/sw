...
@RequestMapping("/stream_survey_site")
@Controller
public class StreamSurveySiteController
{
    private static final String WATER_SURVEY_JSP = "/sitemanage/stream_survey_site/list";
