...
<body>
	<div align="center" style="background-color: #393D49; color: #fff; padding-top: 25px; padding-bottom: 25px;">
		<form id="soilsEditForm" action="${ctx}/soils/editSaveSoilsInfo" method="post">
			<input type="hidden" id="id" name="id" value="${soilTypeInfo.id}">
			<table border="0" cellspacing="15" style="line-height: 25px; border-collapse:separate; border-spacing:0px 10px;">
				<tr>
					...
					<td><input type="text" id="soilName" name="soilName" value="${soilTypeInfo.soilName}" style="color:black; width:233px;"/></td>
				</tr>
				
				<tr>
					<td align="right">土地类型描述：</td>
					<td><textarea id="description" name="description" rows="2" cols="35" maxlength="256" style="color:black; resize:none;">${soilTypeInfo.description}</textarea></td>
				</tr>
				
				<tr>
					<td align="right">备注信息：</td>
					<td><textarea id="stiRemark" name="stiRemark" rows="2" cols="35" maxlength="256" style="color:black; resize:none;">${soilTypeInfo.stiRemark}</textarea></td>
				</tr>
			</table>
		</form>
	</div>
