...
<body >
	...
	function setValue(msg,month,a1,a2,a3,a4,b1,b2,b3,b4,c1,c2,c3,c4,m){
		...
		var earlyDay = document.getElementById(a2);	
			earlyDay.innerHTML=((msg[0].descendingArrangement)*3600*24/10000).toFixed(3);
		var early = document.getElementById(a3);	
			early.innerHTML=((msg[0].descendingArrangement)*3600*24*10/10000).toFixed(3);
		...
		var middleDay = document.getElementById(b2);	
			middleDay.innerHTML=((msg[1].descendingArrangement)*3600*24/10000).toFixed(3);
		var middle = document.getElementById(b3);	
			middle.innerHTML=((msg[1].descendingArrangement)*3600*24*10/10000).toFixed(3);
		...
		var lastDay = document.getElementById(c2);	
			lastDay.innerHTML=((msg[2].descendingArrangement)*3600*24/10000).toFixed(3);
		var last = document.getElementById(c3);	
			last.innerHTML=((msg[2].descendingArrangement)*3600*24*11/10000).toFixed(3);
		var lastYear = document.getElementById(c4);	
			lastYear.value=msg[2].contrastYear;
			
			
		var oneFlow = document.getElementById(m);
			oneFlow.innerHTML=((msg[0].descendingArrangement)*3600*24*10/10000
					+(msg[1].descendingArrangement)*3600*24*10/10000
					+(msg[2].descendingArrangement)*3600*24*11/10000).toFixed(3);
	}
