...
<div align="center" style="background-color: #393D49; color: #fff; padding-top: 25px; padding-bottom: 25px;">
	<form id="areaAddForm" action="${ctx}/sys_water_area/add" method="post" >
		<table border="0" style="border-collapse:separate; border-spacing:0px 10px;">
			<%--<input type="hidden" id="id" name="id" value="${id}"/>--%>
			<input type="hidden" id="waterAreaLevel" name="waterAreaLevel" value="${waterAreaLevel}"/>
			<input type="hidden" id="parentWaterareaId" name="parentWaterareaId" value="${parentWaterareaId}"/>
			<tr>
				<td align="right"><span style="color: red">*</span>区域编码：</td>
				<td><input type="text" class="form-control" id="waterAreaCode" name="waterAreaCode" value="${waterAreaCode}" style="width:233px;"/></td>
			</tr>

			<tr>
				<td align="right"><span style="color: red">*</span>区域名称：</td>
				<td><input type="text" class="form-control" id="waterAreaName" name="waterAreaName" style="width:233px;"/></td>
			</tr>

			<tr>
				<td align="right">备注信息：</td>
				<td><textarea id="swaRemark" name="swaRemark" class="form-control" rows="2"  style="resize:none;"></textarea></td>
			</tr>
		</table>
	</form>
</div>
