...
<body >
		<div style="padding: 30px; line-height: 22px; background-color: #393D49; color: #fff; font-weight: 300;">
    				<form  id="form" action="${ctx}/reservoir/edit" method="post" enctype="multipart/form-data">
    				...
    				<table border="0" style="border-collapse:separate; border-spacing:20px 18px;">
						...
						<tr>
							<td align="center" class="w54"  colspan="3">
								<span hidden="true" id="areaSpan">${sysAreaNames}<span>
							</td>
						...
						<tr>
							<td align="center" class="w54"  colspan="3">
								<span hidden="true" id="waterAreaSpan">${waterAreaNames}<span>
							</td>
							
						</tr>
						<tr>	
							<td align="right"><span style="color: red" class="w7">*</span>行政区编码：</td><td class="w18"><input value="${siteReservoirInfo.sysareaCode}"  class="form-control" type="text" readonly="true" id="sysareaCode" name="sysareaCode"  style="color:black;width:180px;"/></td>
							<td align="right"><span style="color: red" class="w7">*</span>水管区编码：</td><td class="w18"><input value="${siteReservoirInfo.syswaterareaCode}"  class="form-control" type="text" readonly="true" id="syswaterareaCode" name="syswaterareaCode"  style="color:black;width:180px;"/></td>
						</tr>
						...
						<tr>
							<td align="right"><span style="color: red" class="w7">*</span>水库建设时间：</td><td class="w18"><input  class="form-control" type="text" id="sriBuildTime" name="sriBuildTime" value="<fmt:formatDate value='${siteReservoirInfo.sriBuildTime}' type='date' pattern='yyyy-MM-dd'/>"   onfocus="WdatePicker({'skin':'whyGreen','dateFmt':'yyyy-MM-dd'});" style="color:black;width:180px;"  /></td>
						...
						<tr>	
							...
							<td class="w18">
								...
								<select  name="threeLevelAreaName" id="threeLevelAreaName" value="${siteReservoirInfo.threeLevelAreaName}" class="form-control" style="color:black;width:180px;height:35px;">
										...
										<option id="黑河001" value="黑河001">黑河001</option>
										<option id="黑河002" value="黑河002">黑河002</option>
										<option id="黑河003" value="黑河003">黑河003</option>
										<option id="黑河004" value="黑河004">黑河004</option>
										<option id="黑河005" value="黑河005">黑河005</option>
										<option id="黑河006" value="黑河006">黑河006</option>
								</select>
								</td>
							...
							<select  name="belongsCanalCode" id="belongsCanalCode" value="${siteReservoirInfo.belongsCanalCode}" class="form-control" style="color:black;width:180px;height:35px;">
										...
										<c:forEach items="${calCanalInfoList}" var="calCanalInfo">
										  	<option id="${calCanalInfo.id}" value="${calCanalInfo.canalCode}">${calCanalInfo.canalName}</option>
										</c:forEach>
							</select>
							</td>
						...
						<tr>	
							...
							<td class="w18">
								...
								<select  name="engineeringLevel" id="engineeringLevel" value="${siteReservoirInfo.engineeringLevel}" class="form-control" style="color:black;width:180px;height:35px;">
										...
										<option id="1" value="1">Ⅰ</option>
										<option id="2" value="2">Ⅱ</option>
										<option id="3" value="3">Ⅲ</option>
										<option id="4" value="4">Ⅳ</option>
										<option id="5" value="5">Ⅴ</option>
										<option id="6" value="6">Ⅵ</option>
										<option id="7" value="7">Ⅶ</option>
										<option id="8" value="8">Ⅷ</option>
										<option id="9" value="9">Ⅸ</option>
										<option id="10" value="10">Ⅹ</option>
								</select>
							</td>
						...
						<tr>	
							<td align="right"><span style="color: red" class="w7">*</span>取水口水量：</td><td class="w18"><input class="form-control" type="text" id="waterMouth" name="waterMouth" value="${siteReservoirInfo.waterMouth}" style="color:black;width:180px;"/></td>
						...
						<tr>	
							...
							<td class="w18">
								<%-- <input class="form-control" type="text" name="supplyObject" value="${siteReservoirInfo.supplyObject}" style="color:black;width:180px;"/> --%>
								<%-- <select  name="supplyObject" id="supplyObject" value="${siteReservoirInfo.supplyObject}" class="form-control" style="color:black;width:180px;height:35px;">
										<option value="">--请选择--</option>
										<option id="农业灌溉" value="农业灌溉">农业灌溉</option>
										<option id="城乡生活" value="城乡生活">城乡生活</option>
										<option id="工矿企业" value="工矿企业">工矿企业</option>
								</select> --%>
								<select  name="supplyObject" id="supplyObject" value="${siteReservoirInfo.supplyObject}" class="form-control" style="color:black;width:180px;height:35px;">
											<option value="">--请选择--</option>
											<c:forEach items="${calCanalUsetypeList}" var="CalCanalUsetype">
											  	<option id="${CalCanalUsetype.canalUsetypeCode}ff" value="${CalCanalUsetype.canalUsetypeCode}">${CalCanalUsetype.canalUsetypeName}</option>
											</c:forEach>
								</select>
							</td>
							...
							<td class="w18">
								...
								<select  name="damFunction" id="damFunction" value="${siteReservoirInfo.damFunction}" class="form-control" style="color:black;width:180px;height:35px;">
										<option value="">--请选择--</option>
										<option id="挡水坝001" value="挡水坝001">挡水坝001</option>
										<option id="挡水坝002" value="挡水坝002">挡水坝002</option>
										<option id="挡水坝003" value="挡水坝003">挡水坝003</option>
										<option id="挡水坝004" value="挡水坝004">挡水坝004</option>
										<option id="挡水坝005" value="挡水坝005">挡水坝005</option>
								</select>
							</td>
						</tr>
						...
						<tr>	
							...
							<td class="w18">
								...
								<select  name="damMaterialType" id="damMaterialType" value="${siteReservoirInfo.damMaterialType}" class="form-control" style="color:black;width:180px;height:35px;">
										<option value="">--请选择--</option>
										<option id="土坝" value="土坝">土坝</option>
										<option id="堆石坝" value="堆石坝">堆石坝</option>
								</select>
								</td>
							...
							<td class="w18">
								...
								<select  name="damStructureType" id="damStructureType" value="${siteReservoirInfo.damStructureType}" class="form-control" style="color:black;width:180px;height:35px;">
										<option value="">--请选择--</option>
										<option id="心墙坝" value="心墙坝">心墙坝</option>
										<option id="面板坝" value="面板坝">面板坝</option>
								</select>
							</td>
						</tr>
						...
						<tr>	
							...
							<%-- <input class="form-control" type="text" name="releaseFloodWatersBuilding" value="${siteReservoirInfo.releaseFloodWatersBuilding}" style="color:black;width:180px;"/> --%>
								<select  name="releaseFloodWatersBuilding" id="releaseFloodWatersBuilding" value="${siteReservoirInfo.releaseFloodWatersBuilding}" class="form-control" style="color:black;width:180px;height:35px;">
										<option value="">--请选择--</option>
										<option id="岸坡式" value="岸坡式">岸坡式</option>
										<option id="隧洞式" value="隧洞式">隧洞式</option>
								</select>
							</td>
						...
						<tr>	
							...
							<%-- <input class="form-control" type="text" name="engineeringConstructionSituation" value="${siteReservoirInfo.engineeringConstructionSituation}" style="color:black;width:180px;"/> --%>
								<select  name="engineeringConstructionSituation" id="engineeringConstructionSituation" value="${siteReservoirInfo.engineeringConstructionSituation}" class="form-control" style="color:black;width:180px;height:35px;">
										<option value="">--请选择--</option>
										<option id="已建" value="已建">已建</option>
										<option id="未建" value="未建">未建</option>
								</select>
							</td>
						</tr>
						...
						<tr>	
							...
							<%-- <input class="form-control" type="text" name="mainDamLevel" value="${siteReservoirInfo.mainDamLevel}" style="color:black;width:180px;"/> --%>
								<select  name="mainDamLevel" id="mainDamLevel" value="${siteReservoirInfo.mainDamLevel}" class="form-control" style="color:black;width:180px;height:35px;">
										<option  value="">--请选择--</option>
										<option id="一级" value="一级">一级</option>
										<option id="二级" value="二级">二级</option>
										<option id="三级" value="三级">三级</option>
										<option id="四级" value="四级">四级</option>
										<option id="五级" value="五级">五级</option>
										<option id="六级" value="六级">六级</option>
								</select>
							</td>
						</tr>
						...
						<tr>	
							...
							<td align="right"><span style="color: red" class="w7">*</span>防洪限制水位(m)：</td><td class="w18"><input type="text" class="form-control" id="fhxzsw" name="fhxzsw" value="${siteReservoirInfo.fhxzsw}" style="color:black;width:180px;"/></td>
						</tr>
						...
						<tr>	
							<td align="right"><span style="color: red" class="w7">*</span>蓄水位相应水面面积（km²）：</td><td class="w18"><input class="form-control" type="text" id="zcxswxysmmj" name="zcxswxysmmj" value="${siteReservoirInfo.zcxswxysmmj}" style="color:black;width:180px;"/></td>
							<td align="right"><span style="color: red" class="w7">*</span>重要保护对象：</td><td class="w18"><input class="form-control" type="text" name="zybhdx" id="zybhdx" value="${siteReservoirInfo.zybhdx}" style="color:black;width:180px;"/></td>
						</tr>
						
						<tr>	
							<td align="right"><span style="color: red" class="w7">*</span>灌溉对象灌区名称：</td><td class="w18"><input class="form-control" type="text" id="gxmc" name="gxmc" value="${siteReservoirInfo.gxmc}" style="color:black;width:180px;"/></td>
						...
						<tr>	
							<td align="right"><span style="color: red" class="w7">*</span>是否完成划界：</td><td class="w18">
								...
								<select  name="sfwchj" id="sfwchj"  class="form-control" style="color:black;width:180px;height:35px;">
										<option value="">--请选择--</option>
										<option id="0hj" value="0">是</option>
										<option id="1hj" value="1">否</option>
								</select>
								</td>
							<td align="right"><span style="color: red" class="w7">*</span>是否完成确权：</td><td class="w18">
								...
								<select  name="sfwcqq" id="sfwcqq"  class="form-control" style="color:black;width:180px;height:35px;">
										<option value="">--请选择--</option>
										<option id="0qq" value="0">是</option>
										<option id="1qq" value="1">否</option>
								</select>
							</td>
						</tr>
						<tr>	
							<td align="right">联系电话：</td><td class="w18"><input type="text"  class="form-control" id="contentPhone" name="contentPhone" value="${siteReservoirInfo.contentPhone}" style="color:black;width:180px;"/></td>
							<td align="right">联系人员：</td><td class="w18"><input type="text"  class="form-control" id="contactsPeople" name="contactsPeople" value="${siteReservoirInfo.contactsPeople}" style="color:black;width:180px;"/></td>
						</tr>
						<tr>	
							<td align="right"><span style="color: red" class="w7">*</span>水库设计灌溉面积单位(万亩)：</td><td class="w18"><input class="form-control" type="text" name="reservoirIrrigatedAcreage" value="${siteReservoirInfo.reservoirIrrigatedAcreage}" style="color:black;width:180px;"/></td>
						...
						<input hidden="hidden"  type="text" name="id" value="${siteReservoirInfo.id}" style="color:black;"/>
    				</table>
	        		</form>
       		 </div>
	...
	window.onload = function(){
		...
		//所属河流
		var belongsCanalCode = "${siteReservoirInfo.belongsCanalCode}";
		document.getElementById(belongsCanalCode).selected=true;
		//三级流域
		var threeLevelAreaName = "${siteReservoirInfo.threeLevelAreaName}";
		document.getElementById(threeLevelAreaName).selected=true;
		//工程级别
		var engineeringLevel = "${siteReservoirInfo.engineeringLevel}";
		document.getElementById(engineeringLevel).selected=true; 
		
		//坝的用途功能
		var damFunction = "${siteReservoirInfo.damFunction}";
		document.getElementById(damFunction).selected=true; 
		
		//大坝材质类型
		var damMaterialType = "${siteReservoirInfo.damMaterialType}";
		document.getElementById(damMaterialType).selected=true; 
		
		//大坝结构分类
		var damStructureType = "${siteReservoirInfo.damStructureType}";
		document.getElementById(damStructureType).selected=true; 
		
		//大坝泄洪建筑物
		var releaseFloodWatersBuilding = "${siteReservoirInfo.releaseFloodWatersBuilding}";
		document.getElementById(releaseFloodWatersBuilding).selected=true;
		
		//工程建设情况
		var engineeringConstructionSituation = "${siteReservoirInfo.engineeringConstructionSituation}";
		document.getElementById(engineeringConstructionSituation).selected=true;
		
		//主坝级别
		var mainDamLevel = "${siteReservoirInfo.mainDamLevel}";
		document.getElementById(mainDamLevel).selected=true;
		
		//是否完成划界
		var sfwchj = "${siteReservoirInfo.sfwchj}hj";
		document.getElementById(sfwchj).selected=true;
		
		//是否完成确权
		var sfwcqq = "${siteReservoirInfo.sfwcqq}qq";
		document.getElementById(sfwcqq).selected=true;
		
		//供水对象
		var supplyObject="${siteReservoirInfo.supplyObject}ff";
		document.getElementById(supplyObject).selected=true;
		
		//水位站
		var siteWaterId="${siteReservoirInfo.siteWaterId}";
		document.getElementById(siteWaterId).selected=true;
	}
	</script>
