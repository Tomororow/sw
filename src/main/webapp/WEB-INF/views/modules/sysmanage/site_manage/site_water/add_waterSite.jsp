...
<body >
    		...
    		<div style="border:1px solid white;width:100%;border-radius:10px">
    			<table border="0" cellspacing="50px" style="line-height: 35px; border-collapse:separate; border-spacing:0px 10px;">
					...
					<tr>	
					 ...
					 <tr>	
						<td class="w7"><span style="color: red">&nbsp;&nbsp;*&nbsp;</span>站点海拔:</td><td class="w18"><input type="text" class="form-control" id="swiHight" name="swiHight" value="${siteWaterInfo.swiHeight}" style="color:black;width:180px;height:30px"/></td>
	...
	function mySubmit(){
		...
		// var swiDeadWaterLevel = document.getElementById("swiDeadWaterLevel").value;
		// var swiMeasureUpperTime = document.getElementById("swiMeasureUpperTime").value;
		// var swiMeasureLowerTime = document.getElementById("swiMeasureLowerTime").value;
