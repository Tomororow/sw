					...
					<div class="container-fluid">
						<div class="info-center">
							<div class="page-header">
								...
								<div id="data_EveryMonth_Traffic" style="width: 60%;height: 300px; margin-top:-10px;float:left">
								</div>
								<div id="data_Sum_Traffic" style="width: 40%;height: 300px; display:inline; float:left;">
								</div>
							  <template>
								<el-table :data="swiList.slice((currentPage-1)*pagesize,currentPage*pagesize)" stripe @row-click="dataTrafficShow" border width="1000px;">
