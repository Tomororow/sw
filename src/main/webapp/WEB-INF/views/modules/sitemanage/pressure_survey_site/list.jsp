...
<form  action="${ctx}/cal_canal_info/list" method="post">
	...
	<!-- 页面主体start -->
	<div class="down-main"  id="pressure_survey_site">
		<!-- 页面主体左侧菜单导航start -->
							...
							<div class="search-box row" style="margin-bottom: 10px;">
								<div class="col-md-12">
									<div class="btn-group pull-left" role="group" aria-label="...">
										...
										<button id="delete_site_sluice_manage" style="display: block"  type="button" class="btn btn-default" >
							...
							<!--||||||||||||新增||||||||||||-->
								 <template>
  									<el-table :data="list.slice((currentPage-1)*pagesize,currentPage*pagesize)" header-align="center" show-overflow-tooltip   stripe  border style="width: 100%">
    									...
    									<el-table-column prop="siteName" align="center" show-overflow-tooltip label="压力站名称" ></el-table-column>
    									<el-table-column prop="siteCode" align="center" show-overflow-tooltip label="压力站编码"></el-table-column>
    									...
    									<el-table-column prop="siteAddress" align="center" show-overflow-tooltip label="压力站地址"></el-table-column>
	...
	<script type="text/javascript" src="${ctxstc}/js/custom/sitemanage/pressure_survey_site/pressure_survey_site.js"></script>
</body>
</html>