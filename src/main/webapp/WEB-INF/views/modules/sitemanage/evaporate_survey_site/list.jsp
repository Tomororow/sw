...
<head>
	...
	<style type="text/css">
		#images .el-form-item__content,#address .el-form-item__content,#adminCode .el-form-item__content{width:480px;}
	</style>
</head>
<body>
<form  action="${ctx}/cal_canal_info/list" method="post">
	...
	<!-- 页面主体start -->
	<div class="down-main"  id="evaporate">
		<!-- 页面主体左侧菜单导航start -->
					...
					<div class="container-fluid">
						<div class="info-center">
							...
							<div class="search-box row" style="margin-bottom: 10px;">
								<div class="col-md-12">
									<div class="btn-group pull-left" role="group" aria-label="...">
										<button id="add_site_sluice_manage" style="display: block" data-toggle="modal" data-target="#myModal"   type="button" class="btn btn-default" v-on:click="showTreeForm(0)" >
							...
							<!--||||||||||||新增||||||||||||-->
									...
									<div class="modal-dialog" style="width:40%">
										<div class="modal-content">
											<div class="modal-header">
												...
												<h4 class="modal-title" id="myModalLabel">新增【{{treeLabel}}】蒸发站信息</h4>
											</div>
	  												...
	  												<!-- <el-form-item label="气象站地址" prop="address"   id="distpicker">
	  			 									...
	  			 									<el-col :span="8">
	  			 										<el-form-item prop="province" id="form1">
	  			 											<div class="form-group" ><select class="form-control" v-model="evaAdd.province" id="province"></select></div>
	  			 										</el-form-item>
	  			 									</el-col>
	  			 									<el-col :span="8">
	  			 										<el-form-item prop="city" id="form2">
	  			 											<div class="form-group"><select class="form-control" v-model="evaAdd.city" id="city"></select></div>
	  			 										</el-form-item>
	  			 									</el-col>
	  			 									<el-col :span="8">
	  			 										<el-form-item id="form3">
	  			 											<div class="form-group" ><select class="form-control" v-model="evaAdd.district"  id="district"></select></div>
	  			 										</el-form-item>
	  			 									</el-col>
	  												</div>
	  											</el-form-item> -->
	  												<el-form-item label="详细地址" id="address"  prop="DetailAddress" >
	  													<el-input type="textarea" v-model="evaAdd.DetailAddress"></el-input>
	  												</el-form-item>
	  												<el-form-item label="气象站图片" id="images"  prop="evaporateImage">
	  													<el-input id="fileText" v-model="evaAdd.evaporateImage" disabled  placeholder="只能上传jpg/png文件，且不超过2MB" >
	  														<template slot="append" id="uploadId">
	  															<el-upload class="upload-demo"  ref="upload" :limit="1" :data="map" :on-success="successForms" :on-error="errorForms" :on-change="imageChange" :action="imageUrl" :auto-upload="false">
											...
											<div class="modal-footer">
												...
												<button type="button" class="btn btn-primary" @click="submitAdd('evaAdd')">提交表单</button>
											</div>
										</div>
									</div>
								</div>
								<!--||||||||||||页面表格||||||||||||-->
							  <template>
								<el-table :data="evaporateList.slice((currentPage-1)*pagesize,currentPage*pagesize)" stripe  border style="width: 100%">
									...
									<el-table-column label="操作" align="center" width="140px;" >
										<template slot-scope="scope">
											<el-button type="primary" id="tabCell" size="small" data-toggle="modal" data-target="#updateModal" v-on:click="showTreeForm(scope.row)">修改</el-button>
    										<el-button type="warning" size="small" @click="deleteForms(scope.$index,scope.row,evaporateList)" style="margin-left:0;">删除</el-button>
										</template>
									</el-table-column>
								</el-table>
								<el-pagination @size-change="handleSizeChange" @current-change="handleCurrentChange" :page-sizes="[10, 20, 30, 40]" :current-page.sync="currentPage" :page-size="pagesize" layout="total, prev, pager, next" :total="evaporateList.length" align="right" style="margin-top:10px;"></el-pagination>
    						</template> 
    						...
    						<div class="modal fade" id="updateModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
									<div class="modal-dialog" style="width:40%">
										<div class="modal-content">
											<div class="modal-header">
												<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
												<h4 class="modal-title" id="myModalLabel" style="font-size:14px;">修改【{{treeLabel}}】蒸发站信息</h4>
											</div>
											<div class="modal-body" align="center">
												<el-form ref="evaAdd" :inline="true"  label-width="100px" class="demo-ruleForm" :rules="rulesupdate"   :model="evaAdd" >
	  												<el-form-item label="蒸发站名称" prop="evaporateName" >
	    												<el-input v-model="evaAdd.evaporateName"></el-input>
	  												</el-form-item>
	  												<el-form-item label="蒸发站编码" prop="coding" >
											...
											<div class="modal-footer">
												<button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
												<button type="button" class="btn btn-primary" @click="UpdateForms('evaAdd')">提交表单</button>
											</div>
										</div>
									</div>
								</div>	
	...
	<script type="text/javascript" src="${ctxstc}/js/custom/watersupply/water_works/water_works_list.js"></script>
	<script type="text/javascript" src="${ctxstc}/js/custom/sitemanage/evaporate_survey_site/evaporate_survey_site.js"></script>
</body>
</html>