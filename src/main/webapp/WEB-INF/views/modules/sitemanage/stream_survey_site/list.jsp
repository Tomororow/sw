...
<head>
	...
	<script src="${ctxstc}/css/selfdefault.css}" type="text/javascript"></script>
	<style>
...
<form  action="${ctx}/cal_canal_info/list" method="post">
	...
	<!-- 页面主体start -->
	<div class="down-main"  id="stream_survey_site">
		<!-- 页面主体左侧菜单导航start -->
				...
				<div class="center-back right-back" >
					<div class="container-fluid">
						<div class="info-center">
							...
							<div class="search-box row" style="margin-bottom: 10px;">
								<div class="col-md-12">
									<div class="btn-group pull-left" role="group" aria-label="...">
										<button  style="display: block"   type="button" class="btn btn-default"  >
											<span class="glyphicon glyphicon-plus"></span>新增
										</button>
										<button  style="display: none"  type="button" class="btn btn-default" onclick="deletes()">
							...
							<!-- 表格 -->
 								 <template>
  									<el-table :data="list.slice((currentPage-1)*pagesize,currentPage*pagesize)" header-align="center" show-overflow-tooltip   stripe  border style="width: 100%">
							 			...
							 			<template scope="scope">
  										...
  										<el-table-column prop="istrative" align="center" show-overflow-tooltip label="行政区"></el-table-column>
    									<el-table-column prop="siteName" align="center" show-overflow-tooltip label="流量站名称" ></el-table-column>
    									<el-table-column prop="siteCode" align="center" show-overflow-tooltip label="流量站编码"></el-table-column>
    									<el-table-column prop="longitude" align="center" show-overflow-tooltip label="经度"></el-table-column>
    									<el-table-column prop="Latitude" align="center" show-overflow-tooltip label="纬度"></el-table-column>
    									<el-table-column prop="equipmentModel" align="center" show-overflow-tooltip label="设备型号"></el-table-column>
    									<el-table-column prop="siteAddress" align="center" show-overflow-tooltip label="流量站地址"></el-table-column>
    									<el-table-column label="操作" width="130px;" align="center">
    										<template scope="scope">
    											<el-button type="warning" v-on:click="" size="small">刪除</el-button>
    											<el-button type="primary" v-on:click=""  size="small" style="margin-left:0;">修改</el-button>
    										</template>
    									</el-table-column>
  									</el-table>
  									 <el-pagination @size-change="handleSizeChange" @current-change="handleCurrentChange" :page-sizes="[10, 20, 30, 40]" :current-page.sync="currentPage" :page-size="pagesize" layout="total, prev, pager, next" :total="list.length" align="right" style="margin-top:10px;"></el-pagination>
								</template>
	...
	<script type="text/javascript" src="${ctxstc}/js/custom/sitemanage/stream_survey_site/stream_survey_site.js"></script>
</body>
</html>