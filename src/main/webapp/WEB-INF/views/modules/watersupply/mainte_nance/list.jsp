...
<form  action="${ctx}/cal_canal_info/list" method="post">
						...
						<div class="info-center">
							...
							<!--||||||||||||新增||||||||||||-->
								...
								<el-table :data="moistureList.slice((currentPage-1)*pagesize,currentPage*pagesize)" stripe  border style="width: 100%">
									...
									<el-table-column label="项目" align="center" show-overflow-tooltip prop="moistureName"></el-table-column>
									<el-table-column label="巡检结果" align="center" show-overflow-tooltip prop="coding"></el-table-column>
									<el-table-column label="巡检部门" align="center" show-overflow-tooltip prop="simClip"></el-table-column>
									<el-table-column label="巡检人员" align="center" show-overflow-tooltip prop="equipName"></el-table-column>
									<el-table-column label="巡检时间" align="center" show-overflow-tooltip prop="latitude"></el-table-column>
									<el-table-column label="备注" align="center" show-overflow-tooltip prop="longitude"></el-table-column>
	...
	<script type="text/javascript" src="${ctxstc}/js/custom/watersupply/mainte_nance/mainte_nance.js"></script>
</body>
</html>