...
<body>
	<div  style="padding: 30px; line-height: 22px; background-color: #393D49; color: #fff; font-weight: 300;">
		<form  id="feorm" action="${ctx}/syn_fpud/insertData"  method="post" enctype="multipart/form-data">
    				<table border="0" style="border-collapse:separate; border-spacing:20px 18px;">
						<tr>	
							<td align="right"><span style="color:red">*</span>公司名称:</td><td class="w18"><input type="text" class="form-control" id="deviceSluiceName" name="fpudName" value="" style="color:black;width:180px;"/></td>
							<td align="right"><span style="color:red">*</span>公司编码:</td><td class="w18"><input type="text" class="form-control" id="deviceSluiceCode" name="fpudNumber" value="" style="color:black;width:180px;"/></td>
						</tr>
						<tr>	
							<td align="right"><span style="color: red">*</span>建设时间:</td><td class="w18"><input class="form-control" type="text" class="form-control" name="buildTime" id="ssiBuildTime"  style="color:black;width:180px;" onfocus="WdatePicker({'skin':'whyGreen','dateFmt':'yyyy-MM-dd'});" /></td>
						 ...
						 <tr>	
							...
							<td align="right"><span style="color: red">*</span>经度:</td><td class="w18"><input type="text" class="form-control" id="ssiLongitude" name="longitude"  style="color:black;width:180px;"/></td>
						</tr>
						<tr>	
							
							<td align="right"><span style="color: red">*</span>纬度:</td><td class="w18"><input type="text" class="form-control" id="ssiLatitude" name="latitude"  style="color:black;width:180px;" /></td>
							<td align="right"><span style="color: red">*</span>高程:</td><td class="w18"><input type="text" class="form-control" id="ssiHeight" name="elevation"  style="color:black;width:180px;" /></td>
						</tr>
						...
						<tr>
    				 	...
    				 	<input hidden="hidden"  type="text" name="sysareaId" value="${Addid}"  style="color:black;">
	        		</form>
	</div>
	...
	<script type="text/javascript" src="${ctxstc}/js/custom/watersupply/syn_fpud/syn_fpud.js"></script>
		...
		function mySubmit(){
			...
			if($("#deviceSluiceName").val()==null || $("#deviceSluiceName").val()==""){
				...
				console.log($("#ssiLongitude").val().length);
				$("#feorm").submit();
