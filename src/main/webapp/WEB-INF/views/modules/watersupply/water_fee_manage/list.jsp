...
<body onload="load('')">
						...
						<div class="container-fluid">
							<div class="info-center">
								<div class="page-header">
									<div class="pull-left">
										<h4>灌区信息化平台>智慧供水>水费管理</h4>
									</div>
								</div>
							<div><h4>--->查询:</h4></div>
								<div>
										<div style="float:left;">
											<span style="color: red" class="w7">*</span>起始时间：<input  class="form-control" id="sriBuildTime" type="text"  name="sriBuildTime"   onfocus="WdatePicker({'skin':'whyGreen','dateFmt':'yyyy-MM-dd'});" style="color:black;width:180px;"  />
										</div>
										<div style="float:left;">
											<span style="color: red" class="w7">*</span>结束时间：<input  class="form-control" id="sriBuildTime" type="text"  name="sriBuildTime"   onfocus="WdatePicker({'skin':'whyGreen','dateFmt':'yyyy-MM-dd'});" style="color:black;width:180px;"  />
										</div>
								</div>
									...
									<table class="table table-bordered table-header">
										<thead>
											<tr>
												...
												<td class="w10">上月累计</td>
												<td class="w10">本月累计</td>
												<td class="w10">本月用水</td>
												<td class="w10">本月水费（元）</td>
											</tr>
										</thead>
	...
	<script type="text/javascript" src="${ctxstc}/js/custom/watersupply/wate_fee_manage/wate_fee_manage.js"></script>
	<script type="text/javascript"
	...
	<script>
		...
		function showNodes(threeLevelPermission) {
			...
			var zNode112 = {
					...
					pId : "1-1",
					name : "大堵麻水厂",
					click : "start('1-1-2',3,'" + threeLevelPermission + "');",
					open : false
				};
			zNodes.push(zNode112);
			var zNode113 = {
					id : "1-1-3",
					pId : "1-1",
					name : "童子寺水厂",
					click : "start('1-1-3',3,'" + threeLevelPermission + "');",
					open : false
			};
			zNodes.push(zNode113);
			var zNode114 = {
					id : "1-1-4",
					pId : "1-1",
					name : "小堵麻水厂",
					click : "start('1-1-4',3,'" + threeLevelPermission + "');",
					open : false
			};
			zNodes.push(zNode114);
			//四级树
			var zNode1111 = {
				id : "1-1-1-1",
				pId : "1-1-1",
			...
			var zNode1121 = {
					...
					pId : "1-1-2",
					name : "洪水干线",
					click : "start('1-1-2-1',3,'" + threeLevelPermission + "');",
					open : false
				};
			zNodes.push(zNode1121);
			/* =========================上面这些是演示嗯嗯代码，=============================================================== */
		}
